  ...
  return (
    ...
    <><div className="imageBackground">
            ...
            <div>
              ...
              {castingData?.map
              ((data) => <div className='casting'>
                {data.profile_path!==undefined && <img src={IMGCDNURL + data.profile_path} alt="" />}

                {data.profile_path && <h4>{data.name}</h4>}
               { data.profile_path && <h4>Character: {data.character}</h4>}
